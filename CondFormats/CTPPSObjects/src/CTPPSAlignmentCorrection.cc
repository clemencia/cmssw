...
//----------------------------------------------------------------------------------------------------
CTPPSAlignmentCorrection::CTPPSAlignmentCorrection(double sh_r, double sh_r_e, double sh_x, double sh_x_e,
...
CTPPSAlignmentCorrection::CTPPSAlignmentCorrection(double sh_x, double sh_y, double sh_z, double rot_z) : 
...
void CTPPSAlignmentCorrection::Add(const CTPPSAlignmentCorrection &a, bool sumErrors, bool addShR,
  bool addShZ, bool addRotZ)
{
  /// TODO: proper adding of all three angles
  
  //printf(">> CTPPSAlignmentCorrection::Add, sumErrors = %i\n", sumErrors);
...
void CTPPSAlignmentCorrection::ReadoutTranslationToXY(double dx, double dy)
{
...
void CTPPSAlignmentCorrection::XYTranslationToReadout(double dx, double dy)
{
...
void CTPPSAlignmentCorrection::SetTranslationR(double sh_r, double sh_r_e)
{
  translation_r = sh_r;
...
void CTPPSAlignmentCorrection::SetTranslationZ(double sh_z, double sh_z_e)
{
...
void CTPPSAlignmentCorrection::SetRotationZ(double rot_z, double rot_z_e)
{
  rotation_z = rot_z;
...
void CTPPSAlignmentCorrection::NormalizeRotationZ()
{
...
DDRotationMatrix CTPPSAlignmentCorrection::RotationMatrix() const
{
...
void CTPPSAlignmentCorrection::Print() const
{
...
void CTPPSAlignmentCorrection::WriteXML(FILE *f, bool precise, bool wrErrors, bool wrSh_r, bool wrSh_xy, 
...
vector<double> CTPPSAlignmentCorrection::getValues() const
{
...
void CTPPSAlignmentCorrection::setValues(const std::vector<double> &data)
{
  if (data.size() != 14)
    throw cms::Exception("CTPPSAlignmentCorrection::setValues") << "Data contain " << data.size()
